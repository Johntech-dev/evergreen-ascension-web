...
import { Calendar, Sun, Moon, Landmark, Users } from "lucide-react";

export default function FirstCTPSDiagram() {
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-8">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
            1st CTPS: The Birth of Structured Time
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Humanity's transition from instinctual awareness to structured temporal frameworks
          </p>
        </div>
        ...
        >
          ...
          >
            <div className="p-4 bg-everblue rounded-t-xl">
              <h3 className="text-center font-semibold text-white">The Calendar</h3>
            </div>
            <div className="p-6">
              <p className="text-[15px] text-gray-600 mb-4">
                The foundation of structured time, enabling agricultural planning and social coordination.
              </p>
          ...
          >
            <div className="p-6">
              <h2 className="text-xl font-bold text-gray-800 mb-2">Day/Night Cycle</h2>
              <p className="text-sm text-gray-600 mb-4">
                The most fundamental natural rhythm that guided early timekeeping.
              </p>
              <div className="flex justify-center mt-2">
          ...
          >
            <div className="p-6">
              <h2 className="text-xl font-bold text-gray-800 mb-2">Seasonal Changes</h2>
              <p className="text-sm text-gray-600 mb-4">
                Agricultural cycles that shaped early calendar systems.
              </p>
              <div className="flex justify-center mt-2">
                <div className="w-12 h-12 rounded-full bg-everblue/10 flex items-center justify-center text-everblue">
                  <Moon size={24} />
          ...
          >
            <div className="p-6">
              ...
              <h2 className="text-xl font-bold text-gray-800 mb-2">Social Organization</h2>
              <p className="text-sm text-gray-600">Coordinated activities and collective rituals.</p>
            </div>
          </motion.div>

          {/* Right card - Cultural Memory */}
          <motion.div 
          ...
          >
            <div className="p-6">
              ...
              <h2 className="text-xl font-bold text-gray-800 mb-2">Cultural Memory</h2>
              <p className="text-sm text-gray-600">Preservation of traditions and historical events.</p>
            </div>
          </motion.div>
